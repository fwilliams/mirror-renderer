...
//    glDeleteVertexArrays(1, &normal_view_vao);
  ...
  static Geometry make_cube(const glm::vec3& scale, bool invertNormals = false) {
    ...
    const std::array<glm::vec3, 8> norms {
      glm::vec3(-0.577350, -0.577350,  0.577350), // 0 *
      glm::vec3( 0.577350, -0.577350,  0.577350), // 1 *
      glm::vec3( 0.577350,  0.577350,  0.577350), // 2
      glm::vec3(-0.577350,  0.577350,  0.577350), // 3
      glm::vec3(-0.577350, -0.577350, -0.577350), // 4 *
      glm::vec3( 0.577350, -0.577350, -0.577350), // 5 *
      glm::vec3( 0.577350,  0.577350, -0.577350), // 6
      glm::vec3(-0.577350,  0.577350, -0.577350), // 7
    };
