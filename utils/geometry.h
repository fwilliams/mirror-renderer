...
struct ArrayOfStructs {
  GLuint vbo;
  GLuint ibo;
  GLuint normal_view_vbo;
  size_t num_vertices;
  size_t num_indices;
};

void compute_normals(vertex* vertices, GLuint* indices, size_t num_indices) {
...
ArrayOfStructs make_sphere(double radius, unsigned theta_samples, unsigned phi_samples) {
  ArrayOfStructs ret;
